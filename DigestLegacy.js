...
// v4.28.38 — preparaBozzaDigestLunedi RIMOSSA (zero callers attivi;
// unico caller era lunediMattina_integrale_DISMESSO_, anch'essa rimossa).
// Il flusso digest attuale usa weeklyNewsletterAuthRequest (Editoriale_v1.js).

/* RIMOSSO v4.28.38: preparaBozzaDigestLunedi — 120 righe di codice morto.
...
// v4.28.38 — lunediMattina_integrale_DISMESSO_ RIMOSSA (nome=DISMESSO, zero callers).
// Il flusso lunedì attuale usa solo sendWeeklyAlert() (vedi lunediMattina sopra).
