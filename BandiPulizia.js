...
function bandiPulisciVecchi(dryRun) {
  ...
  // v4.28.44 — FIX: fallback era 17 (=UrlValidato su Bandi_v5). StatoRecord è colonna 24 (idx 23)
  var iStato = c('StatoRecord'); if (iStato < 0) iStato = (typeof COL_B !== 'undefined' ? COL_B.STATO_RECORD - 1 : 23);
