...
// ============================================================================
// TASSONOMIA T1–T10 — source of truth (Silvano, 02/08/2026)
// Nota: T4 NON esiste nella numerazione ufficiale, non inventarlo.
// T10 = espressioni culturali pertinenti alla filosofia della webapp ma non
// coperte da T1–T9 (design, arti performative, turismo culturale non-T7...).
// Ogni contenuto riceve una tipologia principale + Aderenza 0–100.
// ============================================================================

var OC_TIPOLOGIE = [
  { cod: 'T1',  nome: 'Riqualificazione, progettazione, musealizzazione spazi della cultura',
    esempi: 'recupero edifici, restauri funzionali, allestimenti, concept museografico', ambito: 3 },
  { cod: 'T2',  nome: 'Sistemi HW/SW e AI per la fruizione di musei e luoghi della cultura',
    esempi: 'piattaforme, app, audioguide AI, virtual center, catalogo digitale, CMS museali', ambito: 5 },
  { cod: 'T3',  nome: 'Accessibilità integrata',
    esempi: 'fisica, cognitiva, sensoriale: LIS, ETR, CAA, Braille semplificato', ambito: 2 },
  { cod: 'T5',  nome: 'Audience, partecipazione, ingaggio, welfare culturale, co-progettazione',
    esempi: 'community engagement, mediazione culturale, edutainment, governance condivisa', ambito: 4 },
  { cod: 'T6',  nome: 'Gestione e valorizzazione patrimonio per EE.PP.',
    esempi: 'piani di gestione, modelli organizzativi, sostenibilità economica', ambito: 5 },
  { cod: 'T7',  nome: 'Sviluppo di asset turistici a base culturale',
    esempi: 'DMC, DMO, valorizzazione borghi, heritage tourism, gastronomia, paesaggio', ambito: 4 },
  { cod: 'T8',  nome: 'Sviluppo territoriale integrato',
    esempi: 'sistemi cultura + turismo + ambiente, GAL, contratti di fiume, distretti', ambito: 4 },
  { cod: 'T9',  nome: 'Creazione e gestione contenuti culturali e museali',
    esempi: 'storytelling, narrazione, didattica, cataloghi, contenuti scientifici', ambito: 1 },
  { cod: 'T10', nome: 'Altre espressioni culturali pertinenti',
    esempi: 'design, arti performative, cinema, musica, editoria culturale', ambito: 0 }
];

var OC_ADERENZA_SOGLIA = 40;   // sotto: pertinente ma classificazione debole → revisione
...
function getOcConstants() {
  // v4.28.36: lettura singola property commerciale (1 PropertiesService call anziché 4)
  var _cc = {};
  try { var _raw = PropertiesService.getScriptProperties().getProperty(OC_PROP_KEY_COMMERCIAL); if (_raw) _cc = JSON.parse(_raw); } catch(e){}
  return {
    ambiti: OC_AMBITI,
    version: {
      number: OC_VERSION,
    ...
    // v4.28.36: lettura singola della property commerciale (era 4 getProperty separate)
    calendarUrl:        _cc.calendarUrl        || OC_CALENDAR_URL,
    museiSensibiliUrl:  _cc.museiSensibiliUrl   || OC_MUSEI_SENSIBILI_URL,
    logoUrl:            _normalizeDriveUrl_(_cc.logoUrl || OC_LOGO_URL),
    heroImageUrl:       _normalizeDriveUrl_(_cc.heroImageUrl || OC_HERO_IMAGE_URL)
  };
}
