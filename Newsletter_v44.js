...
function nlDiagnosiBozza() {
  ...
  return {
    ...
    // v4.28.34 — FIX: prima mostrava home.news/podcast, il top-5/top-3 della
    // HOME (getHomepageDataV42) — non il bacino che la bozza usa davvero da
    // v4.28.34 in poi. Con quei numeri il diagnostico poteva dire "ok, 5 voci"
    // mentre la bozza finale, dopo i filtri, ne aveva 0: non avrebbe MAI
    // segnalato il difetto segnalato da Silvano il 07/08. Ora riporta il
    // bacino reale (getNewsListV42/getPodcastListV42), lo stesso che alimenta
    // _generateDigestDraftCore_.
    daHomepage: {
      news:    prova('news',    function () { return getNewsListV42(150); }).voci,
      podcast: prova('podcast', function () { return getPodcastListV42(80); }).voci,
